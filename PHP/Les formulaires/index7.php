<?php
    ...
    $_FILES['test']['size'];
    $extension = pathinfo($_FILES['test']['name'], PATHINFO_EXTENSION);
    ...
    <form name="test" id="form" method="GET" action="index7.php">
        <select name="civilité" size="1">
        <option>Monsieur
        <option>Madame
        <input type="text" name="nom"/>
...
<form enctype="multipart/form-data" action="index7.php" method="post">
